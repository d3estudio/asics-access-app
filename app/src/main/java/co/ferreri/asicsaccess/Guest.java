...
public class Guest {
     ...
     * @param qrCode
     */
    public Guest(int id, String name, String email, String qrCode, String occupation, String updatedAt, String removedAt, String nameClean) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.qrCode = qrCode;
